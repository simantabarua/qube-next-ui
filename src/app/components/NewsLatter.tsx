        ...
        <div className="min-w-full h-96 px-10  py-5  relative flex items-center rounded-3xl overflow-hidden ">
          ...
          <div className="relative z-[3] flex flex-col  justify-between gap-10">
            ...
            <div className="flex items-center space-x-2">
              <input
                type="text"
                className="w-64 px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Enter your Email..."
              />
              <button className="px-8 py-3 text-white font-bold bg-primary rounded-md shadow-xl hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Subscribe
              </button>
            </div>
            <p className="">
